...
import { ACCESS_TOKEN_KEY, REFRESH_TOKEN_KEY, ACCESS_TOKEN_EXPIRATION_KEY } from '../constants/StorageKey'
...
export const getToken = async () => {
    ...
    if (expiration_date !== null && moment().isBefore(parseInt(expiration_date))) {
...
export const newcomerLogin = async (login, password) => {
    try {
        ...
        if (
            ...
            Alert.alert("Erreur lors de l'identification", "L'identifiant ou le mot de passe fournit sont incorrects", [
                { text: 'Ok' },
            ])
